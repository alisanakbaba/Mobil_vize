...
class KitapEklemePage extends StatefulWidget {
  final Map<String, dynamic>? bookData;
  final String? bookId;

  const KitapEklemePage({super.key, this.bookData, this.bookId});

  @override
  _KitapEklemePageState createState() => _KitapEklemePageState();
}

class _KitapEklemePageState extends State<KitapEklemePage> {
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if(int.tryParse(kitap['sayfa'])==null|| int.tryParse(kitap['yil']) ==null){
