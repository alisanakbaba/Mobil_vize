...
import 'package:kutuphane_otomasyon/pages/kitap_ekleme.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const KitapEklemePage()),
          );
        },
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (yayin) {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => KitapEklemePage(
                                          bookData: data,
                                          bookId: document.id)),
                                );
                              },
                                    ...
                                    return AlertDialog(
                                      ...
                                      actions: [
                                        ...
                                        TextButton(
                                          ...
                                          child: const Text('Silmek istiyorum.'),
                                        )
                                      ],
                                    );
                                  },
                    ...
                    return Container(); // Yayınlanmamış kitapları gösterme
                  }
                },
              );
            } else {
